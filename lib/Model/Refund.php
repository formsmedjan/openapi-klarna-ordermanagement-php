...
class Refund implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets order_lines
     *
     * @param \FormsmedjanKlarnaOrderManagement\Model\OrderLine[]|null $order_lines Order lines for the refund shown to the customer. Optional but increases the customer experience. Maximum 1000 order lines.
     *
     * @return self
     */
