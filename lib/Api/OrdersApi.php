...
class OrdersApi
{
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FormsmedjanKlarnaOrderManagement\Model\CancelNotAllowedErrorMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FormsmedjanKlarnaOrderManagement\Model\Order|\FormsmedjanKlarnaOrderManagement\Model\NoSuchOrderErrorMessage
     */
     ...
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FormsmedjanKlarnaOrderManagement\Model\Order|\FormsmedjanKlarnaOrderManagement\Model\NoSuchOrderErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderWithHttpInfo($order_id, $klarna_integrator = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FormsmedjanKlarnaOrderManagement\Model\Order' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FormsmedjanKlarnaOrderManagement\Model\Order', []),
            ...
            $returnType = '\FormsmedjanKlarnaOrderManagement\Model\Order';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FormsmedjanKlarnaOrderManagement\Model\Order',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $order_id Order id (required)
     * @param  string $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. (optional)
     * @param  \FormsmedjanKlarnaOrderManagement\Model\UpdateAuthorization $body body (optional)
     *
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  string $order_id Order id (required)
     * @param  string $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. (optional)
     * @param  \FormsmedjanKlarnaOrderManagement\Model\UpdateAuthorization $body (optional)
     *
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  string $order_id Order id (required)
     * @param  string $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. (optional)
     * @param  \FormsmedjanKlarnaOrderManagement\Model\UpdateConsumer $body body (optional)
     *
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  string $order_id Order id (required)
     * @param  string $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. (optional)
     * @param  \FormsmedjanKlarnaOrderManagement\Model\UpdateConsumer $body (optional)
     *
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  string $order_id Order id (required)
     * @param  string $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. (optional)
     * @param  \FormsmedjanKlarnaOrderManagement\Model\UpdateMerchantReferences $body body (optional)
     *
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  string $order_id Order id (required)
     * @param  string $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. (optional)
     * @param  \FormsmedjanKlarnaOrderManagement\Model\UpdateMerchantReferences $body (optional)
     *
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
