...
namespace FormsmedjanKlarnaOrderManagement\Api;
...
use FormsmedjanKlarnaOrderManagement\HeaderSelector;
...
class CapturesApi
{
     ...
     * @param  \FormsmedjanKlarnaOrderManagement\Model\UpdateShippingInfo $body body (optional)
     *
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     ...
     * @param  string $capture_id Capture id (required)
     * @param  string $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. (optional)
     * @param  \FormsmedjanKlarnaOrderManagement\Model\UpdateShippingInfo $body (optional)
     *
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
            ...
            switch ($e->getCode()) {
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FormsmedjanKlarnaOrderManagement\Model\NotAllowedErrorMessage',
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FormsmedjanKlarnaOrderManagement\Model\NoSuchOrderErrorMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $order_id Order id (required)
     * @param  \FormsmedjanKlarnaOrderManagement\Model\CaptureObject $body Capture request data (required)
     * @param  string $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. (optional)
     *
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FormsmedjanKlarnaOrderManagement\Model\CaptureNotAllowedErrorMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $capture_id Capture id (required)
     * @param  string $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. (optional)
     * @param  \FormsmedjanKlarnaOrderManagement\Model\ExtendDueDateRequest $body body (optional)
     *
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  string $capture_id Capture id (required)
     * @param  string $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. (optional)
     * @param  \FormsmedjanKlarnaOrderManagement\Model\ExtendDueDateRequest $body (optional)
     *
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FormsmedjanKlarnaOrderManagement\Model\ErrorMessageDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FormsmedjanKlarnaOrderManagement\Model\Capture|\FormsmedjanKlarnaOrderManagement\Model\NoSuchOrderErrorMessage
     */
     ...
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FormsmedjanKlarnaOrderManagement\Model\Capture|\FormsmedjanKlarnaOrderManagement\Model\NoSuchOrderErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCaptureWithHttpInfo($order_id, $capture_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FormsmedjanKlarnaOrderManagement\Model\Capture' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FormsmedjanKlarnaOrderManagement\Model\Capture', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
                    if ('\FormsmedjanKlarnaOrderManagement\Model\NoSuchOrderErrorMessage' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FormsmedjanKlarnaOrderManagement\Model\NoSuchOrderErrorMessage', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FormsmedjanKlarnaOrderManagement\Model\Capture';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FormsmedjanKlarnaOrderManagement\Model\Capture',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FormsmedjanKlarnaOrderManagement\Model\ExtendDueDateOptions|\FormsmedjanKlarnaOrderManagement\Model\ErrorMessageDto
     */
     ...
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FormsmedjanKlarnaOrderManagement\Model\ExtendDueDateOptions|\FormsmedjanKlarnaOrderManagement\Model\ErrorMessageDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOptionsForExtendDueDateWithHttpInfo($order_id, $capture_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FormsmedjanKlarnaOrderManagement\Model\ExtendDueDateOptions' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FormsmedjanKlarnaOrderManagement\Model\ExtendDueDateOptions', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
                    if ('\FormsmedjanKlarnaOrderManagement\Model\ErrorMessageDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FormsmedjanKlarnaOrderManagement\Model\ErrorMessageDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FormsmedjanKlarnaOrderManagement\Model\ExtendDueDateOptions';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FormsmedjanKlarnaOrderManagement\Model\ExtendDueDateOptions',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FormsmedjanKlarnaOrderManagement\Model\NoSuchCaptureErrorMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
