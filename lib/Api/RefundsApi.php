...
class RefundsApi
{
     ...
     * @return \FormsmedjanKlarnaOrderManagement\Model\Refund|\FormsmedjanKlarnaOrderManagement\Model\NotFoundErrorMessage
     */
     ...
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FormsmedjanKlarnaOrderManagement\Model\Refund|\FormsmedjanKlarnaOrderManagement\Model\NotFoundErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithHttpInfo($order_id, $refund_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FormsmedjanKlarnaOrderManagement\Model\Refund' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FormsmedjanKlarnaOrderManagement\Model\Refund', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
                    if ('\FormsmedjanKlarnaOrderManagement\Model\NotFoundErrorMessage' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FormsmedjanKlarnaOrderManagement\Model\NotFoundErrorMessage', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FormsmedjanKlarnaOrderManagement\Model\Refund';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FormsmedjanKlarnaOrderManagement\Model\Refund',
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FormsmedjanKlarnaOrderManagement\Model\NotFoundErrorMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \FormsmedjanKlarnaOrderManagement\Model\RefundObject $body body (optional)
     *
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  string $order_id Order id (required)
     * @param  string $klarna_idempotency_key This header will guarantee the idempotency of the operation. The key should be unique and is recommended to be a UUID version 4. Retries of requests are safe to be applied in case of errors such as network errors, socket errors and timeouts. (optional)
     * @param  \FormsmedjanKlarnaOrderManagement\Model\RefundObject $body (optional)
     *
     * @throws \FormsmedjanKlarnaOrderManagement\ApiException on non-2xx response
     * @throws \InvalidArgumentException
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FormsmedjanKlarnaOrderManagement\Model\RefundNotAllowedErrorMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
