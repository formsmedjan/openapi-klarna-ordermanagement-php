...
namespace FormsmedjanKlarnaOrderManagement;

use FormsmedjanKlarnaOrderManagement\Model\ModelInterface;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if ($class === '\SplFileObject') {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\FormsmedjanKlarnaOrderManagement\Model\\' . $data->{$discriminator};
